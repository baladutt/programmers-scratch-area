...
public class MyEditor extends JFrame {
	...
	public MyEditor() {
		...
		BufferPane bufferPane = new BufferPane();
		content.add(bufferPane.getJComponent(), BorderLayout.CENTER);
		buffer = new Buffer(this, bufferPane);
		setJMenuBar(createMenuBar());
		setSize(320, 240);
	}

	// Add icons and friendly names to actions we care about.
	protected void makeActionsPretty(JTextComponent textComp) {
		Action a;
	...
	class OpenAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent ev) {
			...
			try {
				...
				buffer.read(reader, null);
			} catch (IOException ex) {
				JOptionPane.showMessageDialog(MyEditor.this, "File Not Found",
	...
	class SaveAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent ev) {
			...
			try {
				...
				JOptionPane.showMessageDialog(MyEditor.this, "File Not Saved",
						"ERROR", JOptionPane.ERROR_MESSAGE);
			} finally {
				if (writer != null) {
					try {
